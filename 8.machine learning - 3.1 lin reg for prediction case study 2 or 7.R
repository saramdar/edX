#8.machine learning - 3.1 linear regression for prediction case study 2 or 7
...
#if x-1 is large, the digit is probably a 7
#if x-1 is small and x-2 is in the middle, the digit is probably a 2
